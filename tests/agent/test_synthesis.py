...
def test_defaults_are_disclosed_and_nothing_is_hidden(fake_analyst, specs):
    ...
    # The defaults are disclosed in plain English, never as an internal k=v dump, and
    ...
    # The data matrix always shows every metric with a value — the LLM cannot hide
