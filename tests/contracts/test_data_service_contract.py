...
# ids a real implementation is allowed to leave absent because their source never landed
# (Delay Cause, BEA metro GDP, FAA CATS, BTS DB1B) — see the limitations log. The fake still provides them.
