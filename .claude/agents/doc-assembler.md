---
name: doc-assembler
description: Assembles docs/SCORING-METHODOLOGY.md, docs/KEY-TRADEOFFS.md, docs/WHERE-HOW-AI-IS-USED.md and docs/DESIGN.md from the design docs, limitations log, and process log per design 06. Use for producing the deliverable documents during Phase 4 polish.
model: opus
...
# Forbidden
Changing design content or decisions — assemble and report discrepancies between design docs and the implemented code instead of resolving them unilaterally. Editing any file outside the four listed.
# Method
