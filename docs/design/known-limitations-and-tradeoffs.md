...
| 9 | Free-tier LLM limits (~10 RPM primary) | Constraint | Tool loops must be short; bursts fail over | LiteLLM chain, ≤6 calls/answer, follow-ups reuse session memory; **no silent fallback — fail loudly with actionable message** | Accepted |
